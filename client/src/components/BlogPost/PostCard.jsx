  ...
  return (
    <>
      <div className="flex flex-wrap -mx-4 mx-5 ">
        <div className="w-96 h-96 rounded overflow-hidden shadow-lg bg-opacity-25 flex flex-col mx-2 border-solid">
          ...
          >
            ...
            <footer className="flex justify-between items-end pt-2">
              ...
              <div className="flex items-center">
                ...
                <a
                  href={`/post/${post._id}`}
                  className="bg-blue-500 text-white font-medium px-2 py-1 rounded-lg no-underline hover:bg-blue-700"
                >
                  reed more
                </a>
            </footer>
